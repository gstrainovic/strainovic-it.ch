<template>
  <div id="#">
            ...
            <div class="row">
              <div class="col-lg-7">
                <h1 class="display-4 text-white">
                  ...
                  <span class="mt-2"
                    >Software, Homepage & Webseite erstellen und vermarkten
                    lassen.</span
                  >
                </h1>
              </div>
      ...
      <div class="container pt-lg pb-100">
        <div class="row">
          <div class="col-lg-6">
            ...
            <ul class="lead text-white">
              ...
              <ul class="text-white">
                <li>VBA</li>
                <li>Word, Excel, Access, Outlook & Powerpoint</li>
              </ul>
              <li>Intranet</li>
              <li>
            ...
            <h6 class="display-3 mt-5 text-white">Ziele</h6>
          </div>
        ...
        <div class="row row-grid mt-3">
          <div class="col-lg-6">
            ...
            <h4 class="text-white mt-3">Benutzerfreundlichkeit</h4>
          ...
          <div class="col-lg-6">
            ...
            <h4 class="text-white mt-3">Lizenzkosten & Erweiterungen</h4>
            <p class="text-white mt-3">
          ...
          <div class="col-lg-6">
            ...
            <h4 class="text-white mt-3">Automation</h4>
            <p class="text-white mt-3">
          ...
          <div class="col-lg-6">
            <!-- <icon name="ni ni-atom" size="lg" gradient="white" shadow round color="primary"></icon> -->
            <h4 class="text-white mt-3">Sicherheit</h4>
            <p class="text-white mt-3">
          ...
          <div class="col-lg-6">
            <!-- <icon name="ni ni-atom" size="lg" gradient="white" shadow round color="primary"></icon> -->
            <h4 class="text-white mt-3">Schulung</h4>
            <p class="text-white mt-3">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h6 class="display-3 mt-5 text-white">Lösungen</h6>
          </div>
        </div>
        <div class="row row-grid mt-3">
          <div class="col-lg-6">
          ...
          <div class="col-lg-6">
            <!-- <icon name="ni ni-atom" size="lg" gradient="white" shadow round color="primary"></icon> -->
            <h4 class="text-white mt-3">Software nach Mass</h4>
            <p class="text-white mt-3">
    ...
    <section id="webdesign-und-programmierung" class="section section-lg">
      <div class="container">
    ...
    >
      ...
      <div class="container pt-lg pb-100">
        <div class="row">
          <div class="col-lg-6">
            <h2 class="display-1 text-white">Marketing</h2>
            <h3 class="display-4 text-white">Online & Printmedien</h3>
            <p class="lead text-white">
              Wir helfen Ihnen Ihre Produkte und Dienstleistungen bekannter zu
        ...
        <div class="row row-grid mt-3">
          ...
          <div class="col-lg-6">
            ...
            <p class="text-white mt-3">
              ...
              Ihrem Produkt oder Dienstleistungen zu überzeugen und so es zu
              verkaufen. Dabei setzen wir auf ein breites Multimedia Angebot wie
              Texte schreiben, Videos und Fotos zu beschaffen oder durch unseren
              Fotografen zu erstellen.
            </p>
          </div>
          <div class="col-lg-6">
            <!-- <icon name="ni ni-atom" size="lg" gradient="white" shadow round color="primary"></icon> -->
            <h4 class="text-white mt-3">Datenbeschaffung</h4>
            <p class="text-white mt-3">
