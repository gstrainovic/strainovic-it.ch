export default {
  ...
  'komplexe-webanwendungen-webapplikationen-portale-programmierenund-designen-wir-im-frontend-mit-html-css-3-bootstrap-und-react-oder-vue-und-im-backend-mit-z-b-headless-cms-node-php-python-und-als-datenbanken-z-b-sql-wie-mysql-mariadb-oder-nosql-wie-z-b-mongodb':
    'Komplexe Webanwendungen, Webapplikationen, Portale programmieren und designen wir im Frontend mit HTML, CSS3, Bootstrap und React oder Vue, und im Backend mit z. B. Headless CMS, Node, PHP, Python und als Datenbanken z. B. SQL wie MySQL, MariaDB oder NoSQL wie z.B. MongoDB. ',
  // "###########Webdesign": "###########",
  ...
  'software-homepage-and-webseite-erstellen-und-vermarkten-lassen':
    'Software, Homepage & Webseite erstellen und vermarkten lassen.',
  index: {
    h2:
  ...
  nachdem:
    ' Nachdem alle Arbeiten abgeschlossen sind, erfolgen Qualitätstests. Dabei wird z. B. bei Webseiten geprüft, ob alles auf allen Geräten und alle Browsern korrekt dargestellt wird. ',
  'schulung-lead':
    ' Sie und ggf. Ihre Mitarbeiter erhalten entweder bei Ihnen lokal oder remote über TeamViewer eine Schulung, um z. B. im Webshop selbstständig Produkte zu aktualisieren. ',
  'wartung-and-sicherheit': 'Wartung & Sicherheit',
  'keine-sorge':
    ' Keine Sorge vor Ausfällen oder Hacker. Durch die Übernahme der Updates und Backups bleibt die gesamte Software wie z. B. CMS, Plugins, Server aktuell und ausfallsicher. ',
  'fehlerbehebung-and-support': 'Fehlerbehebung & Support',
  'auch-nach':
    ' Auch nach dem Projektende können Sie mit einem zuverlässigen Partner rechnen, welcher Störungen behebt. ',
  // Impressum
  ...
  'der-durch-kreativitaet-und-ausdauer-herausforderungen-meistert-und-ziele-erreicht':
    'der durch Kreativität und Ausdauer Herausforderungen meistert und Ziele erreicht.',
  'gruender-von-strainovic-it': 'Gründer von Strainovic IT',
  skills: 'Skills',
  sprachkenntnisse: 'Sprachkenntnisse',
  'deutsch-englisch-serbisch-rumaenisch':
    'Deutsch, Englisch, Serbisch, Rumänisch',
  elektroniker: 'Elektroniker',
  'pruefen-reparieren-avor-technischer-support-von-elektronik-baugruppen':
    'Prüfen, Reparieren, Avor, technischer Support von Elektronik Baugruppen',
  ...
  'ticketplugin-fuer-jira-projektmanagementsoftware':
    'Ticketplugin für Jira - Projektmanagementsoftware',
  ...
  'redesign-eines-taximeter-app-fuer-android':
    'Redesign eines Taximeter App für Android',
