    ...
    <section class="section section section-shaped my-0 overflow-hidden">
      <div class="container pt-lg pb-100">
        ...
        <div class="row">
          <blockquote class="blockquote lead ">
            <p class="mb-0">
              ...
              der durch Kreativität und Ausdauer Herausforderungen meistert und
              Ziele erreicht.
            </p>
        ...
        <div class="row">
          <div class="row mb-5 ">
            <div class="col-lg-12">
              <h3 class="display-3 mt-5 ">Meine Skills</h3>
              <h4 class="display-4 mt-5 ">Meine Sprachkenntnisse</h4>
              <p class="lead mb-5">Deutsch, Englisch, Serbisch, Rumänisch</p>
              <h4 class="display-4 mt-5 ">Als Elektroniker</h4>
              <p class="lead mb-5">
              ...
              <p class="lead">
                Akquise, Analysieren, Konzepterstellung, Beraten, Planen,
                Managen, Schulen
              </p>
              <h4 class="display-4 mt-5 ">
          ...
          <div class="row mb-5 ">
            <div class="col-lg-12">
              <h3 class="display-3 ">Meine Ausbildung</h3>
